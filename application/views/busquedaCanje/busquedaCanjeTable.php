        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button id="<?php echo $data['FolioCanje']; ?>" type="button" class="info-data" data-toggle="modal" data-target="#ModalEdit" onclick="editarInfo(this)"><i class="fas fa-edit"></i></button></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
