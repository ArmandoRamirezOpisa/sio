            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div id="messageAlert" class="alert alert-danger alert-dismissible fade show contentAnimated" role="alert">
                        <strong>Advertencia!</strong> Algun campo esta vacio.
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="usuarioSio" aria-describedby="emailHelp" placeholder="Escribe tu usuario...">
